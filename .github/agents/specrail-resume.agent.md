...
description: "Use for resuming an in-progress SpecRail workflow by inspecting current state, recent history, and the next valid stage before making changes."
